    ...
    <section className='pt-32 pb-40 px-6 relative'>
      <div className='mx-auto text-center '>
        <div className=' max-w-4xl mx-auto text-center'>
          ...
          <p className='md:text-xl text-gray-600 mb-16 md:max-w-2xl max-w-2xl text-lg mx-auto leading-relaxed'>
          ...
          {/* the gradiant */}
          <div className='absolute left-1/2 transform -translate-x-1/2 -top-16 w-full max-w-4xl h-80 bg-gradient-to-b from-red-50/30 via-primary-red-accent/20 to-transparent pointer-events-none' />
          ...
          <div className='flex flex-col sm:flex-row gap-6 justify-center mb-20'>
            <MotionButton
              ...
              className='bg-primary-red hover:bg-primary-red-hover text-white px-9 py-6 text-lg hover-lift'
            >
              Get Started Free
            </MotionButton>
            <MotionButton
              ...
              transition={{ type: 'tween', ease: 'easeOut', duration: 0.1 }}
              variant='outline'
              className='px-9 py-6 text-lg  hover:bg-gray-50 '
            >
              Request Beta Access
            </MotionButton>
          </div>
